...
export function StockTransfer() {
  ...
  const handleSubmitTransfer = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch((import.meta.env.VITE_API_URL || '') + '/api/inventory/transfers', {
        method: "POST",
  ...
  const handleApprove = async (id: string) => {
    ...
    try {
      const res = await fetch((import.meta.env.VITE_API_URL || '') + `/api/inventory/transfers/${id}/approve`, {
        method: "POST"
      });
  ...
  const handleCancel = async (id: string) => {
    ...
    try {
      const res = await fetch((import.meta.env.VITE_API_URL || '') + `/api/inventory/transfers/${id}/cancel`, {
        method: "POST"
      });
