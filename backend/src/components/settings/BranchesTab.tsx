...
export function BranchesTab() {
  const { data: branchesList, isLoading: branchesLoading, error: branchesError, mutate: mutateBranches } = useSWR('/api/stores')
  ...
  const handleBranchSubmit = async () => {
    ...
    try {
      const url = (editingBranch ? `/api/stores/${editingBranch.id}` : '/api/stores');
