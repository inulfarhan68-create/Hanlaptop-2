...
export const PLAN_SEED: PlanSeed[] = [
    ...
    {
        key: "pro", name: "Pro", sortOrder: 2, priceMonthly: 139_000, isPublic: true,
        maxStores: 1, maxUsers: 5, maxTransactionsPerMonth: null, storageLimitMb: null,
    ...
    {
        key: "business", name: "Business", sortOrder: 3, priceMonthly: 299_000, isPublic: true,
        maxStores: 5, maxUsers: 15, maxTransactionsPerMonth: null, storageLimitMb: null,
